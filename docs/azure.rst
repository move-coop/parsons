...
`Azure Blob Storage <https://azure.microsoft.com/en-us/products/storage/blobs/>`__ is a cloud file storage system that
...
`block blobs, not page or append blobs <https://learn.microsoft.com/en-us/rest/api/storageservices/understanding-block-blobs--append-blobs--and-page-blobs>`__.
