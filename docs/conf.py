...
project = u'Parsons'
copyright = u'2019, The Movement Cooperative'
author = u'The Movement Cooperative'
...
exclude_patterns = [u'_build', 'Thumbs.db', '.DS_Store', '_template.rst']
...
latex_documents = [
    (master_doc, 'Parsons.tex', u'Parsons Documentation',
     u'The Movement Cooperative', 'manual'),
]
...
man_pages = [
    (master_doc, 'parsons', u'Parsons Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Parsons', u'Parsons Documentation',
     author, 'Parsons', 'One line description of project.',
     'Miscellaneous'),
]
