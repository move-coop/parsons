...
.. admonition:: Authentication
   ...
   Some methods in the :class:`~parsons.mobilize_america.ma.MobilizeAmerica` class
   require an API Key furnished by Mobilize America (private methods),
   while others do not (public methods). Each method in this class contains
   a note indicating whether it is public or private. For more information, see the
   `API documentation <https://github.com/mobilizeamerica/api/blob/main/README.md#authentication>`__.

Quickstart
==========

If you instantiate :class:`~parsons.mobilize_america.ma.MobilizeAmerica` without an API Key, you can only use public methods:
