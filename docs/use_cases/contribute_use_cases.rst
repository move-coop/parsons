...
A "use case" is a narrative description of any length (but usually at least a couple paragraphs) explaining
the problem the user faced and why and how they used Parsons to solve it.
...
.. note::
   ...
   Not sure how to set environmental variables?

   You can set them from the command line:
