...
class ActionBuilder:
    ...
    Args:
        ...
        subdomain (str, optional): The part of the web app URL preceding '.actionbuilder.org'.
            Defaults to None.
        campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved or
            edited. Can also be supplied in individual methods in case multiple campaigns need to be referenced.
            Defaults to None.
    ...
    def get_campaign_tags(self, campaign=None, limit=None, per_page=25, filter=None):
        ...
        Args:
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
            limit (int, optional): The number of entries to return. When None, returns all entries.
                Defaults to None.
            per_page (int, optional): The number of entries per page to return. 25 maximum and default.
                Defaults to 25.
            filter (str, optional): The OData query for filtering results. E.g. "modified_date gt '2014-03-25'".
    ...
    def get_tag_by_name(self, tag_name, campaign=None):
        ...
        Args:
            tag_name (str): The value of the tag to search for.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def insert_new_tag(self, tag_name, tag_field, tag_section, campaign=None):
        ...
        Args:
            tag_name (str): The name of the new tag, i.e. the custom field value.
            tag_field (str): The name of the tag category, i.e. the custom field name.
            tag_section (str): The name of the tag section, i.e. the custom field group name.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def insert_entity_record(self, entity_type, data=None, campaign=None):
        ...
        Args:
            entity_type (str): The name of the record type being inserted. Required if identifiers are not provided.
            data (dict, optional): The details to include on the record being upserted, to be included as the value
                of the
                `person` key. See [documentation for the Person
                SignupHelper](https://www.actionbuilder.org/docs/v1/person_signup_helper.html#post) for examples, and
                [the Person endpoint](https://www.actionbuilder.org/docs/v1/people.html#field-names) for full entity
                object composition. Defaults to None.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def update_entity_record(self, identifier, data, campaign=None):
        ...
        Args:
            identifier (str): The unique identifier for a record being updated. ID strings will need to begin with
                the origin system, followed by a colon, e.g.
                `action_builder:abc123-...`.
            data (dict): The details to include on the record being upserted, to be included as the value of the
                `person` key. See
                [documentation for the Person Signup
                Helper](https://www.actionbuilder.org/docs/v1/person_signup_helper.html#post) for examples, and
                [the Person endpoint](https://www.actionbuilder.org/docs/v1/people.html#field-names) for full entity
                object composition.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def remove_entity_record_from_campaign(self, identifier, campaign=None):
        ...
        Records cannot be permanently deleted, but a record that has been removed from a campaign will not appear in the
        UI.

        Args:
            identifier (str): The unique identifier for the record being removed. ID strings will need to begin with
                the origin system, followed by a colon, e.g.
                `action_builder:abc123-...`.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def add_section_field_values_to_record(self, identifier, section, field_values, campaign=None):
        ...
        Args:
            identifier (str): The unique identifier for a record being updated. ID strings will need to begin with
                the origin system, followed by a colon, e.g.
                `action_builder:abc123-...`.
            section (str): The name of the tag section, i.e. the custom field group name.
            field_values (dict): A collection of field names and tags stored as keys and values.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def remove_tagging(
        ...
        """
        Remove one or more tags (i.e. custom field value) from an existing entity or connection record in Action
        Builder. The basis for this end point is the combination of the tag's interact ID and that of the specific
        tagging. The tag ID can usually be determined from the tag's name, and the tagging ID can be derived if the
        identifier of the entity or connection record is supplied instead.

        Args:
            identifier: The unique identifier for an entity or connection record being updated.
                If omitted, `tagging_id` must be provided. Defaults to None.
            tag_id: The unique identifier for the tag being removed. If omitted, `tag_name` must be provided.
                Defaults to None.
            tag_name: The exact name of the tag being removed. May result in an error if multiple tags (in different
                fields/sections) have the same name. If omitted,
                `tag_id` must be provided. Defaults to None.
            tagging_id: The unique identifier for the specific application of the tag to an individual entity or
                connection record. If omitted, `identifier` must be provided. Defaults to None.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
    ...
    def upsert_connection(self, identifiers, tag_data=None, campaign=None, reactivate=True):
        ...
        Only one connection record is allowed per pair of entities, so if the connection already exists, this method
        will update, but will otherwise create a new connection record.

        Args:
            identifiers (list): A list of two unique identifier strings for records being connected.
                ID strings will need to begin with the origin system, followed by a colon, e.g.
                `action_builder:abc123-...`. Requires exactly two identifiers.
            tag_data (list[dict], optional): Tags to be added to the connection record (i.e.
                Connection Info). See [documentation on Connection
                Helper](https://www.actionbuilder.org/docs/v1/connection_helper.html#post) for examples.
                Defaults to None.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
            reactivate (bool, optional): Whether or not to set the `inactive` flag on a given Connection to False if
                the Connection exists and has `inactive` set to True. True by default. Defaults to True.
    ...
    def deactivate_connection(
        ...
        Only one connection record is allowed per pair of entities, so this can be done by supplying the ID for the
        connection record, or for the two connected entity records.

        Args:
            from_identifier (str): Unique identifier for one of the two entities with a connection.
            connection_identifier: The unique identifier for an entity or connection record being updated.
                If omitted, `to_identifier` must be provided. Defaults to None.
            to_identifier: The second entity with a connection to `from_entity`. If omitted,
                `connection_identifier` must be provided. Defaults to None.
            campaign (str, optional): The 36-character "interact ID" of the campaign whose data is to be retrieved
                or edited. Not necessary if supplied when instantiating the class. Defaults to None.
