...
class ActionKit:
    ...
    Args:
        domain (str): The ActionKit domain (e.g. ``myorg.actionkit.com``) Not required if
            ``ACTION_KIT_DOMAIN`` env variable set.
        username (str): The authorized ActionKit username. Not required if ``ACTION_KIT_USERNAME`` env variable set.
        password (str): The authorized ActionKit user password. Not required if
            ``ACTION_KIT_PASSWORD`` env variable set.
    ...
    def get_user(self, user_id: int):
        ...
        Args:
            user_id (int): The user id of the record to get. TODO: is this really an int?
    ...
    def create_user(self, email: str, **kwargs):
        ...
        Args:
            ...
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
    ...
    def add_phone(self, user_id: str, phone_type: str, phone: str):
        ...
        Returns:
            Any: Phone json object TODO: what type?
    ...
    def update_user(self, user_id: int, **kwargs) -> requests.Response:
        ...
        Returns:
            requests.Response: HTTP response from the patch request.
    ...
    def update_phone(self, phone_id: int, **kwargs) -> requests.Response:
        """
        Update a phone record.

        Args:
            phone_id (int): The phone id of the phone to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found at the
                /rest/v1/phone/schema/ path on any ActionKit instance.
    ...
    def get_event(self, event_id: int) -> dict:
        ...
        Returns:
            dict: Event json object.

        """
        return self._base_get(f"event/{event_id}")

    def get_events(self, limit: int = None, **kwargs) -> Table:
        r"""
        Get multiple events.

        Args:
            limit (int, optional): The number of events to return. If omitted, all events are returned.
                Defaults to None.
            **kwargs: Optional arguments to pass to the client. A full list can be found in the
                `ActionKit API Documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/actionprocessing.html>`__.

                Additionally, expressions to filter the data can also be provided. For addition info, visit `Django's
                docs on field lookups
    ...
    def update_event(self, event_id: int, **kwargs) -> None:
        ...
        Args:
            event_id (int): The event id of the event to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def create_event_field(self, event_id: int, name: str, value: str):
        """
        Create an event field (custom field on an event).

        Note that if an event field with this name already exists, this will add a second record.

        Args:
            event_id (int): The id for the event.
            name (str): The name of the event field.
            value (str): The value of the event field.
    ...
    def update_event_field(self, eventfield_id: int, name: str, value: str) -> None:
        """
        Update an event field.

        Args:
            eventfield_id (int): The id of the event field to update.
            name (str): The name of the event field.
            value (str): The value of the event field.
    ...
    def get_blackholed_email(self, email: str) -> Table:
        r"""
        Get a blackholed email.

        A blackholed email is an email that has been prevented from receiving bulk and transactional emails from
        ActionKit. `Documentation <https://\ docs.actionkit.com/docs/manual/guide/mailings_tools.html#blackhole>`_.

        Args:
            email (str): Blackholed email of the record to get.

        Returns:
            Table: The blackholed email data.
    ...
    def blackhole_email(self, email: str):
        ...
        `Documentation <https://docs.actionkit.com/docs/manual/guide/\ mailings_tools.html#blackhole>`_.

        Args:
            email (str): Email to blackhole.
    ...
    def delete_user_data(self, email: str, **kwargs):
        r"""
        Delete user data.

        Args:
            email (str): Email of user to delete data.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation
                <https://docs.actionkit.com/docs/manual/api/\ rest/users.html>`__.
    ...
    def delete_user(self, user_id: int) -> None:
        ...
        Args:
            user_id (int): The user id of the person to delete.
    ...
    def get_campaign(self, campaign_id: int):
        ...
        Args:
            campaign_id (int): The campaign id of the record.
    ...
    def get_campaign_fields(self) -> list:
        """
    ...
    def create_campaign(self, name: str, **kwargs):
        """
        Create a campaign.
    ...
    def search_events_in_campaign(
        ...
        **kwargs,
        ...
        Args:
            campaign_id (int): The id of the event campaign.
            limit (int | None, optional): The maximum number of objects to return. Defaults to None.
            order_by (str, optional): Event attribute to order the results by. be equivalent to ordering by
                created_at. See `ActionKit's docs on ordering
                <https://roboticdogs.actionkit.com/docs//manual/api/rest/overview.html#ordering>`_.
                Defaults to "id".
            ascdesc (Literal["asc", "desc"], optional): If "asc", returns events ordered by the attribute specified
                by the order_by parameter. If "desc", returns events in reverse order. Defaults to "asc".
            filters (dict, optional): A dictionary for filtering by the attributes of the event or related object.
                Not all attributes are available for filtering, but an eventfield will work. For additional info, visit
                `Django's docs on field lookups
            ...
            exclude (dict, optional): A dictionary for excluding by the attributes of the event or related object.
                Uses the same format as the filters argument. Defaults to None.
            **kwargs: A dictionary of other options for filtering. See `ActionKit's docs on the search API
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/examples/eventsearch.html>`_.

        Returns:
            Table: The list of events.
    ...
    def get_event_create_page(self, event_create_page_id: int):
        """
        Get a event create page.

        Args:
            event_create_page_id (int): The event create page id of the record to get.
    ...
    def create_event_create_page(self, name: str, campaign_id: int, title: str, **kwargs):
        """
        Add an event page to a campaign.

        Args:
            name (str): The name of the page to create.
            campaign_id (int): The campaign to assoicate page with.
    ...
    def get_event_create_form(self, event_create_form_id: int):
        """
        Get a event create form.

        Args:
            event_create_form_id (int): The event create form id of the record to get.
    ...
    def create_event_create_form(self, page_id: int, thank_you_text: str, **kwargs):
        """
        Create a event create form.

        Args:
            page_id (int): The page to associate the form with.
            thank_you_text (str): Free form thank you text.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def get_event_signup_page(self, event_signup_page_id: int):
        """
        Get event signup page.

        Args:
            event_signup_page_id (int): The event signup page id of the record to get.
    ...
    def create_event_signup_page(self, name: str, campaign_id: int, title: str, **kwargs):
        """
    ...
    def get_event_signup_form(self, event_signup_form_id: str):
        """
        Get a user.

        Args:
            event_signup_form_id (str): The event signup form id of the record to get.
    ...
    def create_event_signup_form(self, page_id: int, thank_you_text: str, **kwargs):
        """
    ...
    def update_event_signup(self, event_signup_id, **kwargs) -> None:
        ...
        Args:
            event_signup_id (int): The id of the event signup to update.
            event_signup_dict (dict): A dictionary of fields to update for the event signup.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def get_mailer(self, entity_id):
        ...
        Args:
            entity_id (int): The entity id of the record to get.
    ...
    def create_mailer(self, **kwargs):
        ...
        Args:
            **kwargs: Arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/manual/api/\ rest/mailer.html>`_.
    ...
    def update_mailing(self, mailer_id, **kwargs):
        ...
        Args:
            mailer_id (int): The id of the mailing to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def rebuild_mailer(self, mailing_id):
        ...
        Args:
            mailing_id (int): Id of the mailer.
    ...
    def paginated_get(self, object_type, limit=None, **kwargs):
        ...
        Args:
            ...
            limit (int, optional): The number of objects to return. If omitted, all objects are returned.
                Defaults to None.
            **kwargs: Optional arguments to pass to the client. A full list can be found in the
                `ActionKit API Documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/actionprocessing.html>`__.
    ...
    def paginated_get_custom_limit(
        ...
        **kwargs,
        ...
        Args:
            object_type (str): The type of object to search for.
            limit (int, optional): The maximum number of objects to return. Even if the threshold value is not
                reached, if the limit is set, then at most this many objects will be returned.
                Defaults to None.
            threshold_field (str, optional): The field used to determine when to stop. Must be one of the options
                for ordering by. Defaults to None.
            threshold_value (str, optional): The value of the field to stop at. Defaults to None.
            ascdesc (str, optional): If "asc" (the default), return all objects below the threshold value.
                If "desc", return all objects above the threshold value. Defaults to "asc".
            **kwargs: You can also add expressions to filter the data beyond the limit/threshold values above.
    ...
    def get_order(self, order_id):
        ...
        Args:
            order_id (int): The order id of the record to get.
    ...
    def update_order_user_detail(self, user_detail_id, **kwargs):
        ...
        Args:
            user_detail_id (int): The id of the order user detail to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found at the
                /rest/v1/orderuserdetail/schema/ path on any ActionKit instance.
    ...
    def get_orderrecurring(self, orderrecurring_id):
        ...
        Args:
            orderrecurring_id (int): The orderrecurring id of the record to get.
    ...
    def cancel_orderrecurring(self, recurring_id) -> requests.Response:
        ...
        Args:
            recurring_id (int): The id of the recurring order to update (NOT the order_id).
    ...
    def update_orderrecurring(self, orderrecurring_id: int, **kwargs) -> None:
        ...
        Args:
            orderrecurring_id (int): The id of the orderrecurring to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def get_orders(self, limit: int | None = None, **kwargs):
        ...
        Args:
            limit (int | None, optional): The number of orders to return. If omitted, all orders are returned.
                Defaults to None.
            **kwargs: Optional arguments to pass to the client. A full list can be found in the
                `ActionKit API Documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/actionprocessing.html>`__.
    ...
    def update_paymenttoken(self, paymenttoken_id, **kwargs) -> requests.Response:
        ...
        Args:
            paymenttoken_id (int): The id of the payment token to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def get_page_followup(self, page_followup_id):
        ...
        Args:
            page_followup_id (int): The user id of the record to get.
    ...
    def create_page_followup(self, signup_page_id, url, **kwargs):
        ...
        Args:
            signup_page_id (int): The signup page to associate the followup page with.
            url (str): URL of the folloup page.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def get_survey_question(self, survey_question_id):
        ...
        Args:
            survey_question_id (int): The survey question id of the record to get.
    ...
    def update_survey_question(self, survey_question_id, **kwargs) -> None:
        ...
        Args:
            survey_question_id (int): The id of the survey question to update.
            survey_question_dict (dict): A dictionary of fields to update for the survey question.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def create_transaction(self, **kwargs):
        ...
        Args:
            **kwargs: Optional arguments and fields to pass to the client.
    ...
    def get_transactions(self, limit=None, **kwargs):
        ...
        Args:
            limit (int, optional): The number of transactions to return. If omitted, all transactions are returned.
                Defaults to None.
            **kwargs: Optional arguments to pass to the client. A full list can be found in the
                `ActionKit API Documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/actionprocessing.html>`__.
    ...
    def create_generic_action(self, page, email=None, ak_id=None, **kwargs):
        ...
        One of ``ak_id`` or ``email`` is a required argument.

        Args:
            page: The page to post the action. The page short name.
            email: The email address of the user to post the action. Defaults to None.
            ak_id: The action kit id of the record. Defaults to None.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found in the
                `ActionKit API Documentation <https://roboticdogs.actionkit.com/docs/\
                manual/api/rest/actionprocessing.html>`__.
    ...
    def update_import_action(self, action_id, **kwargs) -> requests.Response:
        ...
        Args:
            action_id (int): The action id of the import action to update.
            **kwargs: Optional arguments and fields to pass to the client. A full list can be found at the
                /rest/v1/importaction/schema/ path on any ActionKit instance.
    ...
    def bulk_upload_csv(
        ...
        If you are uploading a table object, use bulk_upload_table instead. See `ActionKit User Upload Documentation
        <https://roboticdogs.actionkit.com/docs/manual/api/rest/uploads.html>`_ Be careful that blank values in columns
        will overwrite existing data.

        If you get a 500 error, try sending a much smaller file (say, one row), which is more likely to return the
        proper 400 with a useful error message

        Args:
            import_page (str): The page to post the action. The page short name.
            csv_file (str or buffer): The csv (optionally zip'd) file path or a file buffer object A user_id or
                email column is required. ActionKit rejects files that are larger than
                128M.
            autocreate_user_fields (bool, optional): When True columns starting with `user_` will be uploaded as
                user fields. See the `autocreate_user_fields documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/uploads.html#create-a-multipart-post-request>`__.
                Defaults to False.
            user_fields_only (bool, optional): When uploading only an email/user_id column and `user_` user fields,
                ActionKit has a fast processing path. This doesn't work, if you upload a zipped csv though.
                Defaults to False.

        Returns:
            dict: Success - whether upload was successful progress_url - an API URL to get progress on upload
                processing res: requests http response object.
    ...
    def bulk_upload_table(
        ...
        <https://roboticdogs.actionkit.com/docs/manual/api/rest/uploads.html>`__. Be careful that blank values in
        columns will overwrite existing data.

        Tables with only an identifying column (user_id/email) and `user_` user fields will be fast-processed -- this is
        useful for setting/updating user fields.
        ...
        Args:
            table: A Table of user data to bulk upload. A user_id or email column is required.
            import_page (str): The page short name to post the action.
            autocreate_user_fields (bool, optional): When True, columns starting with `user_` will be uploaded as
                user fields. See the `ActionKit documentation
                <https://roboticdogs.actionkit.com/docs/manual/api/rest/uploads.html#create-a-multipart-post-request>`__.
                Defaults to 0.
            no_overwrite_on_empty (bool, optional): When True, the table is divided into batches based on column
                permutations to prevent blank values from overwriting existing data. Defaults to False.
            set_only_columns (list, optional): Restricts to a specific set of columns which, if blank, should not be
                overwritten. Defaults to None.

        Returns:
            dict[str, bool | list[dict]]: Success (bool) - Whether the upload was successful for all batches.
                results (list[dict]) - A list of full result objects from each batch, each containing ``progress_url``
                and ``res``.
    ...
    def collect_upload_errors(self, result_array):
        ...
        Args:
            result_array: List After receiving a dict back from bulk_upload_table you may want to see if there were
                any errors in the uploads.  If you call collect_upload_errors(result_array) it will iterate across each
                of the uploads fetching the final result of e.g.
                /rest/v1/uploaderror?upload=123.

        Returns:
            list[dict]: Message: str -- error message upload: str -- upload progress API path e.g.
                "/rest/v1/upload/123456/" id: int -- upload error record id (different than upload id).
