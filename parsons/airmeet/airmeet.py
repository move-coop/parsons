...
class Airmeet:
    ...
    def __init__(self, airmeet_uri=None, airmeet_access_key=None, airmeet_secret_key=None) -> None:
        """
        Authenticate with the Airmeet API and update the connection headers with the access token.

        Args:
            airmeet_uri (str, optional): The Airmeet API endpoint. Defaults to None.
            airmeet_access_key (str, optional): The Airmeet API access key. Defaults to None.
            airmeet_secret_key (str, optional): The Airmeet API secret key. Defaults to None.
    ...
    def _get_all_pages(self, url, page_size=50, **kwargs) -> Table:
        """
        Get all the results from an Airmeet API url, handling pagination based on the returned pageCount.

        Args:
            url (str): Airmeet api url.
            page_size: 50 The number of items to get per page. The max allowed varies by API call.
    ...
    def list_airmeets(self) -> Table:
        ...
        Returns:
            Parsons.Table: List of Airmeets.
    ...
    def fetch_airmeet_participants(
        ...
        """
        Get all participants (registrations) for a specific Airmeet, handling pagination based on the returned
        totalUserCount. This API doesn't use cursors for paging, so we can't use
        _get_all_pages() here.

        Args:
            airmeet_id (str): The id of the Airmeet.
            sorting_key (Literal["name", "email", "registrationDate"], optional): The key to sort the participants
                by. Defaults to "registrationDate".
            sorting_direction (str, optional): Can be either 'ASC' or 'DESC' (the default).
                Defaults to "DESC".

        Returns:
            Parsons.Table: List of participants for the Airmeet event.
    ...
    def fetch_airmeet_sessions(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of sessions for this Airmeet event.
    ...
    def fetch_airmeet_info(self, airmeet_id, lists_to_tables=False):
        """
        Get the data for an Airmeet (event), which include the list of sessions, session hosts/cohosts, and various
        other info.

        Args:
            airmeet_id (str): The id of the Airmeet.
            lists_to_tables (bool, optional): If True, will convert any dictionary values that are lists to Tables.
                Defaults to False.
    ...
    def fetch_airmeet_custom_registration_fields(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of custom registration fields for this Airmeet event.
    ...
    def fetch_event_attendance(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of attendees for this Airmeet event.
    ...
    def fetch_session_attendance(self, session_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of attendees for this session.
    ...
    def fetch_airmeet_booths(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of booths for this Airmeet.
    ...
    def fetch_booth_attendance(self, airmeet_id, booth_id) -> Table:
        ...
        Args:
            airmeet_id (str): The id of the Airmeet.
            booth_id (str): The id of the booth.

        Returns:
            Parsons.Table: List of attendees for this booth.
    ...
    def fetch_poll_responses(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of users. For each user, the value for the "polls" key is a list of poll questions
                and answers for that user.
    ...
    def fetch_questions_asked(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of users. For each user, the value for the "questions" key is a list of that user's
                questions.
    ...
    def fetch_event_tracks(self, airmeet_id) -> Table:
        ...
        Returns:
            Parsons.Table: List of event tracks.
    ...
    def fetch_registration_utms(self, airmeet_id) -> Table:
        ...
        Maximum number of results per page = ?? (documentation doesn't say, but assume 50 like the other asynchronous
        APIs).
        ...
        Returns:
            Parsons.Table: List of UTM parameters captured during registration.
    ...
    def download_session_recordings(self, airmeet_id, session_id=None) -> Table:
        """
        Get a list of recordings for a specific Airmeet (and optionally a specific session in that Airmeet).

        The data for each recording includes a download link which is valid for 6 hours.

        The API returns "recordingsCount" and "totalCount", which implies that the results could be paged like in
        fetch_airmeet_participants(). The API docs don't specify if that's the case, but this method will need to be
        updated if it is.
        ...
        Returns:
            Parsons.Table: List of session recordings.
    ...
    def fetch_event_replay_attendance(self, airmeet_id, session_id=None) -> Table:
        """
        Get all replay attendees for a specific Airmeet (and optionally a specific session in that Airmeet), handling
        ...
        Returns:
            Parsons.Table: List of event replay attendees.
