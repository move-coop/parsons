...
class BillCom(object):
    ...
    def __init__(self, userName, password, orgId, devKey, endPointUrl):
        ...
        response = requests.post(url="%sLogin.json" % endPointUrl, data=params, headers=self.headers)
        self.devKey = devKey
    ...
    def getPayload(self, data):
        ...
        `Args:`
            data: dict
                A dictionary containing the payload to be sent in the request. The devKey and sessionId
                should not be included as they are dealt with separately.
        
        `Returns:`
            A dictionary of the payload to be sent in the request with the devKey and sessionId added.
        """
    ...
    def getCustomerList(self, startCustomer=0, maxCustomer=999):
        ...
        `Returns:`
            A list of dictionaries of customer information for every user from startCustomer to maxCustomer.
        """
        data={
           "start" : startCustomer,
           "max" : maxCustomer,
    ...
    def createCustomer(self, customer):
        ...
        `Returns:`
            ...
            If the customer already exists, this function will not create a new id and instead use the existing id.
        """
