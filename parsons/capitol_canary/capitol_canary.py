...
class CapitolCanary:
    ...
    Args:
        app_id (str, optional): The CapitolCanary provided application id. Not required if
            ``CAPITOLCANARY_APP_ID`` env variable set. Defaults to None.
        app_key (str, optional): The CapitolCanary provided application key. Not required if
            ``CAPITOLCANARY_APP_KEY`` env variable set. Defaults to None.
