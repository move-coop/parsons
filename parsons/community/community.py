...
class Community:
    ...
    Args:
        community_url: Defaults to None.
        community_access_token: Defaults to None.
        community_client_id: Defaults to None.
    ...
    def get_request(self, filename):
        ...
        Args:
            filename (str): Data filename you are requesting. Options:
