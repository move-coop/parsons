...
class DatabaseConnector(ABC):
    ...
    :class:`~parsons.databases.redshift.redshift.Redshift` / :class:`~parsons.google.google_bigquery.GoogleBigQuery` / etc?
    ...
    def copy(
        ...
        Args:
            ...
            table_name: The destination table name (ex. ``my_schema.my_table``).
            if_exists:
