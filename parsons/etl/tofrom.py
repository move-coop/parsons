...
class ToFrom:
    ...
    def to_html(
        ...
        Args:
            ...
            encoding: str
                ...
                <https://docs.python.org/3/library/csv.html#csv.writer/>`__
            errors: str
    ...
    def to_civis(
        ...
        **civisargs,
        ...
        <https://civis-python.readthedocs.io/en/v1.9.0/generated/civis.io.dataframe_to_civis.html#civis.io.dataframe_to_civis>`__
