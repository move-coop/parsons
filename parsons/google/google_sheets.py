...
class GoogleSheets:
    ...
    Args:
        google_keyfile_dict:
            A dictionary of Google Drive API credentials,
            parsed from JSON provided by the Google Developer Console.
            Required if env variable ``GOOGLE_DRIVE_CREDENTIALS`` is not populated.
        subject:
            In order to use account impersonation,
            pass in the email address of the account to be impersonated as a string.

    """

    def __init__(self, google_keyfile_dict: dict | None = None, subject: str | None = None):
        scope = [
    ...
    def _get_worksheet(self, spreadsheet_id: str, worksheet: str | int = 0) -> gspread.Worksheet:
    ...
    def list_worksheets(self, spreadsheet_id: str) -> list[str]:
        ...
        Args:
            spreadsheet_id:
                ...
                Tip: Get this from the spreadsheet URL.
    ...
    def get_worksheet_index(self, spreadsheet_id: str, title: str) -> int:
        """
    ...
    def get_worksheet(
        self, spreadsheet_id: str, worksheet: str | int = 0, skip_header_rows: int = 0
    ) -> Table:
        """
        ...
        Args:
            spreadsheet_id:
                ...
                Tip: Get this from the spreadsheet URL.
            worksheet:
                The index or the title of the worksheet.
                The index begins with 0.

        """
        found_worksheet = self._get_worksheet(spreadsheet_id, worksheet)
        tbl = Table(found_worksheet.get_all_values()[skip_header_rows:])
    ...
    def share_spreadsheet(
        ...
        spreadsheet_id: str,
        sharee: str | None,
        share_type: Literal["user", "group", "domain", "anyone"] = "user",
        role: Literal["owner", "writer", "reader"] = "reader",
        notify: bool = True,
        ...
        Args:
            spreadsheet_id:
                ...
                Tip: Get this from the spreadsheet URL.
            sharee:
                User or group e-mail address, domain name to share the spreadsheet with.
            ...
            email_message: The email to be sent if `notify` kwarg set to ``True``.
            with_link: Whether a link is required for this permission.
    ...
    def get_spreadsheet_permissions(self, spreadsheet_id: str) -> Table:
        """
    ...
    def create_spreadsheet(
        self, title: str, editor_email: str | None = None, folder_id: str | None = None
    ) -> str:
        """
        ...
        Args:
            title: The human-readable title of the new spreadsheet
            editor_email:
    ...
    def add_sheet(self, spreadsheet_id: str, title: str, rows: int = 100, cols: int = 25) -> int:
        """
    ...
    def append_to_sheet(
        ...
        **kwargs,
        ...
        if existing_table.num_rows == 0:
            self.overwrite_sheet(spreadsheet_id, table, worksheet, user_entered_value)
            return
    ...
    def paste_data_in_sheet(
        ...
        Args:
            ...
            worksheet:
                The index or the title of the worksheet.
                The index begins with 0.
            header: Whether or not the header row gets pasted with the data.
            startrow:
                Starting row position of pasted data.
                Counts from 0.
            startcol:
                Starting column position of pasted data.
                Counts from 0.
        ...
        data = [table.columns] if header else []
        data.extend(table.data)

        sheet.update(values=data, range_name=data_range)
        ...
        **kwargs,
        ...
        Args:
            spreadsheet_id:
                The ID of the spreadsheet.
                Tip: Get this from the spreadsheet URL.
            table: Data to fills sheet with.
            worksheet:
                The index or the title of the worksheet.
                The index begins with 0.
            user_entered_value:
    ...
    def format_cells(
        self, spreadsheet_id: str, range: str, cell_format: dict, worksheet: str | int = 0
    ) -> None:
        """
        ...
        Args:
            spreadsheet_id:
                ...
                Tip: Get this from the spreadsheet URL.
            range:
                The cell range to format.
                E.g. ``"A2"`` or ``"A2:B100"``
            cell_format:
                The formatting to apply to the range.
                Full options are specified in the
                `CellFormat documentation <https://developers.google.com/workspace/sheets/api/reference/rest/v4/spreadsheets/cells#cellformat>`__.
            worksheet:
                The index or the title of the worksheet.
                The index begins with 0.
    ...
    def read_sheet(self, spreadsheet_id: str, sheet_index: int = 0) -> Table:
    ...
    def read_sheet_with_title(self, spreadsheet_id: str, title: str) -> Table:
        # Deprecated method v0.14 of Parsons.

        logger.warning("Deprecated method. Use get_worksheet() instead.")
        return self.get_worksheet(spreadsheet_id, title)

    def get_sheet_index_with_title(self, spreadsheet_id: str, title: str) -> int:
        # Deprecated method v0.14 of Parsons.
