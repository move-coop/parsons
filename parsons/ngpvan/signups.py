...
class Signups:
    ...
    def get_signups_statuses(self, event_id=None, event_type_id=None):
        """
        Get a list of valid signup statuses for a given event type or event.

        You must pass one of
        ``event_id`` or ``event_type_id`` but not both.

        Args:
            event_id (int, optional): A valid event id. Defaults to None.
            event_type_id (int, optional): A valid event type id. Defaults to None.
    ...
    def get_person_signups(self, vanid):
        ...
        Args:
            vanid (int): A valid vanid associated with a person.
    ...
    def get_event_signups(self, event_id):
        ...
        Args:
            event_id (int): A valid event_id associated with an event.
    ...
    def get_signup(self, event_signup_id):
        ...
        Args:
            event_signup_id (int): A valid event_signup_id associated with a signup.
    ...
    def create_signup(self, vanid, event_id, shift_id, role_id, status_id, location_id):
        ...
        Args:
            vanid (int): A valid vanid of the person to signup for the event.
            event_id (int): A valid event_id to associate the person with the event.
            shift_id: A shift_id, associated with the event to assign the person.
            role_id: A role_id, associated with the event to assign the person.
            status_id: A status_id of the person.
            location_id: A location_id for the event.

        Returns:
            Int: The event signup id.
    ...
    def update_signup(
        ...
        """
        Update a signup object.

        All of the kwargs will update the values associated with them.

        Args:
            event_signup_id (int): A valid event signup id.
            shift_id (int, optional): The shift_id to update. Defaults to None.
            role_id (int, optional): The role_id to update. Defaults to None.
            status_id (int, optional): The status_id to update. Defaults to None.
            location_id (int, optional): The location_id to update. Defaults to None.
