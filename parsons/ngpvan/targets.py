...
class Targets:
    ...
    def get_targets(self):
        ...
        logger.info("Found %s targets.", tbl.num_rows)
        return tbl
    ...
    def get_target(self, target_id):
        ...
        logger.info("Found target %s.", target_id)
        return r
    ...
    def get_target_export(self, export_job_id):
        ...
        if job_status == "Complete":
            ...
            logger.info("Target export job is pending or in process for %s.", export_job_id)
        else:
    ...
    def create_target_export(self, target_id, webhook_url=None):
        ...
        logger.info("Created new target export job for %s.", target_id)
        return r
