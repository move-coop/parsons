...
class Gmail(SendMail):
    ...
    Args:
        creds_path (str, optional): The path to the credentials.json file. Defaults to None.
        token_path (str, optional): The path to the token.json file. Defaults to None.
        user_id (str, optional): Optional; Sender email address.
            "me" which is used to indicate the authenticated user. Defaults to "me".
    ...
    def _send_message(self, msg):
        ...
        Args:
            msg: Dict Message to be sent as a base64url encode object. i.e. the objects created by the create_*
                instance methods.

        Returns:
            dict: A Users.messages object see
                `https://developers.google.com/gmail/api/v1/reference/users/messages#resource.` for more info.
