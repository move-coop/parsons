...
class QuickBooks:
    ...
    def get_jobcodes(
        ...
        """
        This function allows you to call the /jobcodes endpoint of the Quickbooks Time API.
    ...
    def get_timesheets(
        ...
        """
        This function allows you to call the /timesheets endpoint of the Quickbooks Time API.
    ...
    def get_users(
        ...
        """
        This function allows you to call the /users endpoint of the Quickbooks Time API.
    ...
    def get_schedule_events(
        ...
        """
        This function allows you to call the /schedule_events endpoint of the Quickbooks Time API.
