...
class CountyDetails:
    ...
    county_update_date: datetime | None = None
...
class Scytl:
    ...
    def __init__(self, state: str, election_id: str, county: str = ""):
        self.state = state
    ...
    def _parse_date_to_utc(self, input_dt: str) -> datetime | None:
        ...
        Args:
            input_dt: The datetime string to be parsed.
    ...
    def _parse_file_from_zip_url(self, zipfile_url: str, file_name: str) -> bytes:
        ...
        Args:
            zipfile_url: The url where the zip file can be found.
            election_id: The expected name of the file in the zipfile to read.
    ...
    def _get_latest_counties_scytl_info(
        ...
        Args:
            state: The two-letter state code for the state
            election_id: The election ID for the given election
            version_num: The latest version ID of the election as a string
    ...
    def _parse_county_xml_data_to_precincts(
        ...
        Args:
            county_data: The detail XML file for a county as bytes
            county_details:
                The details class for the county,
                including ``name``, ``id``, and the ``last_updated`` datetime
    ...
    def _parse_state_xml_data_to_counties(self, state_data: bytes, state: str) -> list[dict]:
        ...
        Args:
            state_data: The detail XML file for a state as bytes.
            state: The two-letter state code for the state associated with the file.
    ...
    def _fetch_and_parse_summary_results(
        self, administrator: str, election_id: str, version_num: str, county: str = ""
    ) -> list[dict]:
        """
        ...
        Args:
            administrator:
                The url code for the election administrator, either the two-letter
                state code or the state code and the county, separated by a slash
            election_id: The election id for the given election as a string
            version_num: The latest version ID of the election as a string
            county: The name of the county associated with the summary file
    ...
    def get_detailed_results_for_participating_counties(
        self, county_names: list[str] | None = None, force_update: bool = False
        ...
        Returns:
            ...
            and the list should contain entries for each candidate in each office,
            per vote method, county, and precinct.
