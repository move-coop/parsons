"""Methods used across multiple endpoints of the Parsons Solidarity Tech API connector."""
...
class SolidarityTechBase:
    ...
    def __init__(
        ...
        """
        api_token = check_env.check("SOLIDARITY_TECH_BEARER_KEY", api_token)
    ...
    def _handle_status_codes(
        self, res: requests.Response, codes: dict[HTTPStatus, tuple[bool, str]]
    ) -> bool:
        """
        Handle status codes.
