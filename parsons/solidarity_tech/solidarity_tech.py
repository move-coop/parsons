"""Combined class for interacting with all SolidarityTech API endpoints."""
...
class SolidarityTech(
    ...
    all of which rely on shared methods from
    ...
    you may choose to import a limited endpoint-specific class directly.
    ...
    Some method arguments that accept only specific values
    expect to be supplied as Enum instances.

    .. code-block:: python
       :caption: Importing Enums used in method args.

        from parsons.solidarity_tech import solidarity_tech_datatypes

        print(solidarity_tech_datatypes.ScopeType.CHAPTER)
        ## Printed Output Is: Chapter
