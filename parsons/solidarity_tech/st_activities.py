...
class SolidarityTechActivities(SolidarityTechBase):
    ...
    def get_activities(
        ...
        *,
        ...
        Returns:
            A list of activities entries, along with request metadata.
            If the request metadata dict contains the key ``next_cursor``,
            there is at least one more page of results.
