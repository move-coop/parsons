"""Connector class for interacting with the SolidarityTech Agent Assignments endpoint."""
...
class SolidarityTechAgentAssignments(SolidarityTechBase):
    ...
    def get_agent_assignments(
        ...
        Returns:
            A list of agent assignment entries, along with request metadata.
    ...
    def get_agent_assignment(
        ...
        Returns:
            A single agent assignment entry, along with requested metadata.
    ...
    def create_agent_assignment(
        ...
        *,
        ...
        Returns:
            A single agent assignment entry, as it exists after creating.
        ...
        _ = is_active is not None and payload.update({"is_active": is_active})
    ...
    def update_agent_assignment(
        ...
        *,
        ...
        Returns:
            A single agent assignment entry, as it exists after updating.
    ...
    def delete_agent_assignment(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "agent assignment deleted"),
            HTTPStatus.NOT_FOUND: (False, "agent assignment not found"),
        }
