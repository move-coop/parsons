"""Connector class for interacting with the SolidarityTech Custom User Properties endpoint."""
...
class SolidarityTechCustomUserProperties(SolidarityTechBase):
    ...
    def get_custom_user_properties(
        ...
        Returns:
            A list of custom user property entries, along with request metadata.
    ...
    def create_custom_user_property(
        ...
        Returns:
            A single custom user property entry.
        ...
        _ = description is not None and payload.update({"description": description})
        _ = options is not None and payload.update({"options": options})
        _ = scope_type is not None and payload.update({"scope_type": scope_type})
        _ = scope_id is not None and payload.update({"scope_id": scope_id})
        ...
        data: UserPropertyData = res.json()["data"]
    ...
    def delete_custom_user_property_option(
        ...
        Returns:
            A single custom user property entry, as it exists after deleting the option.
    ...
    def create_custom_user_property_option(
        ...
        Returns:
            A single custom user property entry, as it exists after creating the new option.
        ...
        _ = value is not None and payload.update({"value": value})
