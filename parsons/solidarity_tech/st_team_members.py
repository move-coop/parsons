"""Connector class for interacting with the SolidarityTech Team Members endpoint."""
...
class SolidarityTechTeamMembers(SolidarityTechBase):
    ...
    def create_team_member(
        ...
        _ = member_id is not None and payload.update({"member_id": member_id})
        ...
        _ = full_name is not None and payload.update({"full_name": full_name})
        ...
        _ = task_id is not None and payload.update({"task_id": task_id})
