"""Connector class for interacting with the SolidarityTech Texts endpoint."""
...
class SolidarityTechTexts(SolidarityTechBase):
    ...
    def send_text(
        ...
        *,
        ...
        _ = media_urls is not None and params.update({"media_urls": media_urls})
        _ = attach_contact_card is not None and params.update(
            {"attach_contact_card": attach_contact_card}
        )
        _ = shorten_urls is not None and params.update({"shorten_urls": shorten_urls})
