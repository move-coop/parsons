"""Connector class for interacting with the SolidarityTech User Lists endpoint."""
...
class SolidarityTechUserLists(SolidarityTechBase):
    ...
    def create_user_list(
        ...
        _ = event_id is not None and payload.update({"event_id": event_id})
        _ = user_id is not None and payload.update({"user_id": user_id})
        _ = parameters is not None and payload.update({"parameters": parameters})
    ...
    def update_user_list(
        ...
        """
        payload: dict[str, _JsonType] = {}
        _ = name is not None and payload.update({"name": name})
