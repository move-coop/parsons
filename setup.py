...
EXTRA_DEPENDENCIES = {
    ...
    "dbt-redshift": ["dbt-redshift >= 1.8.0", "dbt-core >= 1.8.0", "rich >= 14"],
    "dbt-bigquery": ["dbt-bigquery >= 1.8.0", "dbt-core >= 1.8.0", "rich >= 14"],
    "dbt-postgres": ["dbt-postgres >= 1.8.0", "dbt-core >= 1.8.0", "rich >= 14"],
    "dbt-snowflake": ["dbt-snowflake >= 1.8.0", "dbt-core >= 1.8.0", "rich >= 14"],
