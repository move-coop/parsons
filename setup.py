...
EXTRA_DEPENDENCIES = {
    ...
    "box": ["boxsdk[jwt] >= 4, < 4.4.0, < 10", "requests-toolbelt >= 1"],
    ...
    "dbt-bigquery": ["dbt-bigquery >= 1.8", "dbt-core >= 1.8"],
    "dbt-postgres": ["dbt-postgres >= 1.8", "dbt-core >= 1.8"],
    "dbt-snowflake": ["dbt-snowflake >= 1.8", "dbt-core >= 1.8"],
