...
def main():
    ...
    if limited_deps.strip().upper() in ("1", "YES", "TRUE", "ON"):
        ...
        extras_require = {
            ...
            "catalist": ["paramiko"],
            "civis": ["civis"],
            "dbt-redshift": ["dbt-redshift", "pydantic>=1.10.17"],
            "dbt-bigquery": ["dbt-bigquery", "pydantic>=1.10.17"],
            "dbt-postgres": ["dbt-postgres", "pydantic>=1.10.17"],
            "dbt-snowflake": ["dbt-snowflake", "pydantic>=1.10.17"],
