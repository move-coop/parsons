...
district_match = {
    ...
    "vb.reg_cass_zip4": "7194",
    "vb.vf_precinct_id": "36",
    "vb.vf_precinct_name": "CITY OF CHICAGO W-26 P-36",
    "vb.vf_ward": "26",
    "vb.vf_township": "",
    "vb.vf_county_code": "031",
    "vb.vf_county_name": "CITY OF CHICAGO",
    "vb.vf_sd": "002",
    "vb.vf_hd": "004",
    "vb.vf_cd": "007",
    "vb.vf_city_council": "",
    "vb.vf_municipal_district": "CHICAGO",
    "vb.vf_county_council": "08",
    "vb.vf_judicial_district": "CHICAGO",
    "vb.vf_school_district": "CHICAGO PUBLIC SCHOOLS",
    "distance_away_km": 0.0,
    "statezip5zip4": "il606227194",
    "zip5zip4": "606227194",
    "FilteredFirstCut.vb.vf_reg_cass_state": "IL",
    ...
    "voters_in_district": "2",
    "z9_latitude": 41.898369,
    "z9_longitude": -87.694382,
}
...
district_expected = [
    ...
    "vb.vf_cd",
    "vb.vf_city_council",
    "vb.vf_municipal_district",
    "vb.vf_county_council",
    "vb.vf_judicial_district",
    ...
    "FilteredFirstCut.vb.vf_hd",
    "FilteredFirstCut.vb.vf_cd",
    "FilteredFirstCut.vb.vf_city_council",
...
address_response = {
    "input": {"address": "100 N Main St, Chicago, IL 60622", "search_type": "address"},
    "error": None,
    "match_found": True,
    "match_data": district_match,
...
radius_response = {
    "input": {
        "first_name": "Billy",
        "last_name": "Blanks",
        "address": "100 N Main St, Chicago, IL",
        "radius_size": "100",
        "radius_unit": "miles",
        "max_results": "10",
        "gender": "a",
    ...
    "output": [
        {
            ...
            "data_fields": {
                ...
                "vb.vf_reg_cass_city": "CHICAGO",
                "vb.vf_reg_cass_state": "IL",
                "ts.tsmart_midterm_general_turnout_score": "85.5",
                "vb.vf_g2016": "Y",
                "vb.vf_precinct_name": "CITY OF CHICAGO W-26 P-36",
                "vb.voterid": "Q8W8682Y",
                "vb.voterbase_phone": "4435705356",
                "vb.tsmart_precinct_id": "36",
                "vb.tsmart_city": "CHICAGO",
                "vb.vf_earliest_registration_date": "20141104",
                "vb.vf_registration_date": "20141104",
                "vb.vf_reg_cass_zip4": "4455",
                "vb.vf_reg_cass_zip": "60622",
    ...
    "output_size": 1,
    "search_latitude": 41.897826,
    "search_longitude": -87.69465,
