...
class TestCopper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.custom_field_tables['custom_fields_options'] = Table([
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140251,
             "options_name": "Public (displayed in map)", "options_rank": 0},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140250,
             "options_name": "New (Needs Processing)", "options_rank": 4},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140252,
             "options_name": "Private (not on map)", "options_rank": 1},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140254,
             "options_name": "National", "options_rank": 5},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140766,
             "options_name": "Not following principles", "options_rank": 3},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 140764,
             "options_name": "International", "options_rank": 6},
            {"id": 109116, "name": "Local Group Subtype", "options_id": 141434,
             "options_name": "Inactive", "options_rank": 2}
        ])
    ...
    def test_process_json(self):
        ...
        fake_response_tables['fake'] = Table([
            {"id": 1, "Simple List Col": ["one", "two", "three"],
             "Mixed List Col": [None, 2, "three"], "Spotty List Col": [1, 2, 3],
             "Multidim List Col": [[1, 2], [None, "two"], []],
             "Simple Dict Col_one": 1, "Simple Dict Col_three": 3,
             "Simple Dict Col_two": 2, "Nested Dict Col_A": 1,
             "Nested Dict Col_B": ["two", 2], "Nested Dict Col_C": [None, 3, "three"]},
            {"id": 2, "Simple List Col": ["four", "five", "six"],
             "Mixed List Col": ["four", None, 6], "Spotty List Col": [],
             "Multidim List Col": [[3, None], [], ["three", "four"]],
             "Simple Dict Col_one": "I", "Simple Dict Col_three": "III",
             "Simple Dict Col_two": "II", "Nested Dict Col_A": ["one"],
             "Nested Dict Col_B": [], "Nested Dict Col_C": 3},
            {"id": 3, "Simple List Col": ["seven", "eight", "nine"],
             "Mixed List Col": [7, "eight", None], "Spotty List Col": [None],
             "Multidim List Col": [["five", 6], [None]], "Simple Dict Col_one": "x",
             "Simple Dict Col_three": "xxx", "Simple Dict Col_two": "xx",
             "Nested Dict Col_A": None, "Nested Dict Col_B": 2,
    ...
    def test_get_activity_types(self, m):
        ...
        processed_at = Table([
            {"category": "system", "count_as_interaction": False, "id": 1, "is_disabled": False,
             "name": "Property Changed"},
            {"category": "system", "count_as_interaction": False, "id": 3, "is_disabled": False,
             "name": "Pipeline Stage Changed"},
            {"category": "user", "count_as_interaction": False, "id": 0, "is_disabled": False,
             "name": "Note"},
