...
donation_1_json = {
    "campaign": {
        "id": 366172,
        "name": "Test Campaign",
        "started_at": "2022-09-20T18:47:05.381Z",
    },
    "donor": {
        "id": 7508840,
        "name": "Megan Rapinoe",
    ...
    "amount": "3.0",
    "formatted_amount": "$3",
    "converted_amount": "3.0",
    "formatted_converted_amount": "$3",
    "converted_net_amount": "2.57",
    "formatted_converted_net_amount": "$2.57",
    "recurring": True,
    "first_recurring_donation": True,
    "amount_refunded": "0.0",
    "formatted_amount_refunded": "",
    "stripe_charge_id": "ABCDEFG123132",
    "id": 25497167,
    "status": "paid",
    "donation_type": "stripe",
    "donation_date": "2022-10-19T17:32:52.613Z",
    "anonymous_donation": False,
    "gift_aid": False,
    "designation": None,
    "join_mailing_list": False,
    "comment": "testing testing",
    "donating_company": None,
    "currency": "USD",
...
donation_2_json = {
    ...
    "amount": "4.0",
    "formatted_amount": "$4",
    "converted_amount": "4.0",
    "formatted_converted_amount": "$4",
    "converted_net_amount": "3.52",
    "formatted_converted_net_amount": "$3.52",
    "recurring": True,
    "first_recurring_donation": True,
    "amount_refunded": "0.0",
    "formatted_amount_refunded": "",
    "stripe_charge_id": "31231213123ASAD",
    "id": 25497700,
    "status": "paid",
    "donation_type": "stripe",
    "donation_date": "2022-10-19T18:19:06.044Z",
    "anonymous_donation": False,
    "gift_aid": False,
    "designation": None,
    "join_mailing_list": False,
...
donation_3_json = {
    ...
    "amount_refunded": "0.0",
    "formatted_amount_refunded": "",
    "stripe_charge_id": "123ABC123ABC",
    "id": 25525370,
    "status": "paid",
    "donation_type": "stripe",
    "donation_date": "2022-10-20T19:33:31.744Z",
    "anonymous_donation": False,
    "gift_aid": False,
    "designation": None,
    "join_mailing_list": False,
...
donor_1_json = {
    "id": 7508840,
    "created_at": "2022-10-19T17:33:18.935Z",
    "updated_at": "2022-10-20T19:34:07.127Z",
    "first_name": "Elizabeth",
    "last_name": "Warren",
    "email": "elizabethwarren@senate.gov",
    "phone": None,
    "address": None,
    "city": None,
    "state": None,
    ...
    "comment": None,
    "donations_count": 2,
    "last_donation_at": "2022-10-20T19:33:31.744Z",
    "total": [{"currency": "USD", "value": 6.0}],
}

donor_2_json = {
    "id": 7509137,
    "created_at": "2022-10-19T18:19:41.794Z",
    "updated_at": "2022-10-19T18:19:41.859Z",
    "first_name": "Paul",
    "last_name": "Wellstone",
    "email": "paulwellstone@senate.gov",
    "phone": None,
    "address": None,
    "city": None,
    "state": None,
    ...
    "comment": None,
    "donations_count": 1,
    "last_donation_at": "2022-10-19T18:19:06.044Z",
...
plan_1_json = {
    ...
    "started_at": "2022-10-20",
    "last_donation_date": "2022-10-20T19:33:31.744Z",
    "next_donation_date": "2022-11-20",
    "status": "active",
}
...
plan_2_json = {
    ...
    "formatted_amount": "$4",
    "payment_method": "Stripe",
    "started_at": "2022-10-19",
    "last_donation_date": "2022-10-19T18:19:06.044Z",
    "next_donation_date": "2022-11-19",
    "status": "active",
}
...
plan_3_json = {
    ...
    "payment_method": "Stripe",
    "started_at": "2022-10-19",
    "last_donation_date": "2022-10-19T17:32:52.613Z",
    "next_donation_date": "2022-11-19",
    "status": "active",
}
