...
class TestGoogleSlides(unittest.TestCase):
    def setUp(self):
        ...
        presentation = self.gs.get_presentation("19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc")
        self.presentation_id = presentation["presentationId"]
        for i in range(len(presentation['slides'])):
            if (i+1)>2:
                self.gs.delete_slide(
                    "19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc",
                    i+1
                )

    def test_get_presentation(self):
        p = self.gs.get_presentation("19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc") 
        self.assertEqual(9144000, p['pageSize']['width']['magnitude'])
   
    def test_get_slide(self):
        s = self.gs.get_slide("19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc", 2)
        self.assertEqual("g26d1b1fa556_2_0", s['objectId'])

    def test_duplicate_slide(self):
        # duplicating slide #2 to create 3 slides
        self.gs.duplicate_slide("19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc", 2)
        p = self.gs.get_presentation("19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc") 
        self.assertEqual(3, len(p['slides']))

    def test_replace_slide_text(self):
        presentation_id="19I-kicyaJV53KoPNwt77KJL10fHzWFdZ_c2mW4XJaxc"
        slide_number=3
        ...
        content = s['pageElements'][0]['shape']['text']['textElements'][1]['textRun']['content']
