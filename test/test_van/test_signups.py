...
signup = {'eventSignupId': 14285,
          ...
          {'vanId': 100349920,
           ...
           'email': None,
           'phone': None},
          'event': {'eventId': 750001004,
                    'name': 'Canvass 01',
                    'shortName': 'Can01'},
          'shift': {'eventShiftId': 19076,
                    'name': 'Default Shift'},
          'role': {'roleId': 263920,
                   'name': 'Leader'},
          'status': {'statusId': 11,
...
signup_expected = ['eventSignupId', 'startTimeOverride', 'endTimeOverride', 'printedLists',
                   'minivanExports', 'supporterGroupId', 'isOfflineSignup', 'contactModeId',
                   'contactOrganizationCommonName', 'contactOrganizationOfficialName', 'email',
                   'firstName', 'lastName', 'middleName', 'phone', 'vanId', 'status_name',
                   'status_statusId', 'event_eventId', 'event_name', 'event_shortName',
                   'shift_eventShiftId', 'shift_name', 'role_name', 'role_roleId',
                   'location_displayName', 'location_locationId', 'location_name']
...
class TestSignups(unittest.TestCase):
    ...
    def test_get_signup_statuses(self, m):
        ...
        # Test events lookup
        self.assertTrue(validate_list(['statusId', 'name'],
